...
st.set_page_config(page_title="الأدوات المتقدمة", layout="wide")
st.title("🛠️ الأدوات المتقدمة (تقارير مالية + تدقيق + مستخدمين)")
...
# ---------- التبويب الثالث: إدارة المستخدمين (للمسؤول فقط) ----------
with tab3:
